...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium">
       ...
       <Link to="/" > <img className='w-20' src={assets.sunlogo} alt='logo'  /> </Link>
        <ul className="hidden sm:flex gap-5 text-sm text-gray-700">
            <NavLink to='/' className='flex flex-col items-center gap-1'>
                <p className=''>Home</p>
                <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 overflow-y-hidden '></hr>
        ...
        <div className="flex items-center gap-6">
            ...
            <div className='group relative'>
                ...
                <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
                    <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded z-100'>
